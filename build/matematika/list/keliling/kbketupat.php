...
<head>
    ...
    <title>Keliling Belah Ketupat</title>
    <link rel="stylesheet" href="../../../../css/kbketupat.css?v=<?php echo time(); ?>">
        ...
        <form action="function/fbketupat.php" method="post">
            <table cellpadding="5">
                <tr>
                    <td>
                        <center>
                            <label id="label" for="sisi">Sisi (s)</label>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <input type="text" name="sisi" id="sisi" placeholder="*Masukkan Sisi">
                        </center>
                    </td>
                </tr>
                <tr>
