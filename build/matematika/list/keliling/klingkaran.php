...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/klingkaran.css?v=<?php echo time(); ?>">
...
<div class="container">
    ...
    <center>
        <form action="function/flingkaran.php" method="post">
            <table cellpadding="5">
                <tr>
                    <td>
                        <center>
                ...
                <tr>
                    <td>
                        <center>
                            <label id="label" for="diameter">Diameter (d)</label>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <input type="text" name="diameter" id="diameter" placeholder="*Masukkan Diameter">
                        </center>
                    </td>
                </tr>
                <tr>
