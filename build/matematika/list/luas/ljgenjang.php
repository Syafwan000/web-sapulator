...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/ljgenjang.css?v=<?php echo time(); ?>">
...
<div class="container">
    ...
    <center>
        <form action="function/fjgenjang.php" method="post">
            <table cellpadding="5">
                <tr>
                    <td>
                        <center>
                            <label id="label" for="alas">Alas (a)</label>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <input type="text" name="alas" id="alas" placeholder="*Masukkan Alas">
                        </center>
                    </td>
                </tr>
                <tr>
