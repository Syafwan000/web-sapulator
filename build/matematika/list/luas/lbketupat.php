...
<head>
    ...
    <link rel="stylesheet" href="../../../../css/lbketupat.css?v=<?php echo time(); ?>">
...
<div class="container">
    ...
    <center>
        <form action="function/fbketupat.php" method="post">
            <table cellpadding="5">
                <tr>
                    <td>
                        <center>
                            <label id="label" for="d1">Diagonal (1)</label>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <input type="text" name="d1" id="d1" placeholder="*Masukkan Diagonal">
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <label id="label" for="d2">Diagonal (2)</label>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td>
                        <center>
                            <input type="text" name="d2" id="d2" placeholder="*Masukkan Diagonal">
                        </center>
                    </td>
                </tr>
                <tr>
